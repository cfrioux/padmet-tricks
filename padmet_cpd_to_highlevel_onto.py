...
"""
For all compounds in padmetRef file,
retrieve its high level ontologies.
Create a json with the ontologies of all metabolites
"""
...
if __name__ == "__main__":
    ...
    padmet_cpds = [node.id for node in padmet.dicOfNode.values() if node.type == "compound"]
